...
The description will be updated as the development progresses.

### Basic Description

Media Tracker is intended to be a web application for keeping tabs on, and/or rating media the user owns and/or has "consumed". The intended medias right now are music, films, tv-series, anime, books, and video games, though this list may be subject to change depending on finding suitable metadata apis.
